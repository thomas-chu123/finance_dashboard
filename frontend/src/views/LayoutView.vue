<template>
  <div class="flex h-screen overflow-hidden transition-colors duration-300">
    <!-- Sidebar -->
    <aside
      class="fixed inset-y-0 left-0 z-50 w-60 bg-[var(--bg-sidebar)] border-r border-[var(--border-color)] transition-transform duration-300 lg:relative lg:translate-x-0"
      ...
      <div class="flex flex-col h-full p-4">
        ...
        <nav class="flex-1 space-y-1">
          ...
          <router-link to="/" custom v-slot="{ href, navigate, isExactActive }">
            <a :href="href" @click="navigate" :class="['flex items-center gap-3 w-full px-3 py-2.5 rounded-lg transition-all duration-200 group', isExactActive ? 'bg-brand-500/10 text-brand-500 dark:text-brand-400' : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50']">
              <LayoutDashboard :size="20" :class="['transition-colors', isExactActive ? 'text-brand-500 dark:text-brand-400' : 'group-hover:text-zinc-900 dark:group-hover:text-zinc-200']" />
              <span class="font-medium text-sm">總覽</span>
            </a>
          </router-link>

          <router-link to="/tracking" custom v-slot="{ href, navigate, isActive }">
            <a :href="href" @click="navigate" :class="['flex items-center gap-3 w-full px-3 py-2.5 rounded-lg transition-all duration-200 group', isActive ? 'bg-brand-500/10 text-brand-500 dark:text-brand-400' : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50']">
              <TrendingUp :size="20" :class="['transition-colors', isActive ? 'text-brand-500 dark:text-brand-400' : 'group-hover:text-zinc-900 dark:group-hover:text-zinc-200']" />
          ...
          <router-link to="/backtest" custom v-slot="{ href, navigate, isActive }">
            <a :href="href" @click="navigate" :class="['flex items-center gap-3 w-full px-3 py-2.5 rounded-lg transition-all duration-200 group', isActive ? 'bg-brand-500/10 text-brand-500 dark:text-brand-400' : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50']">
              <RefreshCcw :size="20" :class="['transition-colors', isActive ? 'text-brand-500 dark:text-brand-400' : 'group-hover:text-zinc-900 dark:group-hover:text-zinc-200']" />
          ...
          <router-link to="/optimize" custom v-slot="{ href, navigate, isActive }">
            <a :href="href" @click="navigate" :class="['flex items-center gap-3 w-full px-3 py-2.5 rounded-lg transition-all duration-200 group', isActive ? 'bg-brand-500/10 text-brand-500 dark:text-brand-400' : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50']">
              <Target :size="20" :class="['transition-colors', isActive ? 'text-brand-500 dark:text-brand-400' : 'group-hover:text-zinc-900 dark:group-hover:text-zinc-200']" />
          ...
          <router-link to="/users" custom v-slot="{ href, navigate, isActive }">
            <a :href="href" @click="navigate" :class="['flex items-center gap-3 w-full px-3 py-2.5 rounded-lg transition-all duration-200 group', isActive ? 'bg-brand-500/10 text-brand-500 dark:text-brand-400' : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50']">
              <Users :size="20" :class="['transition-colors', isActive ? 'text-brand-500 dark:text-brand-400' : 'group-hover:text-zinc-900 dark:group-hover:text-zinc-200']" />
          ...
          <router-link to="/line" custom v-slot="{ href, navigate, isActive }">
            <a :href="href" @click="navigate" :class="['flex items-center gap-3 w-full px-3 py-2.5 rounded-lg transition-all duration-200 group', isActive ? 'bg-brand-500/10 text-brand-500 dark:text-brand-400' : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50']">
              <MessageCircle :size="20" :class="['transition-colors', isActive ? 'text-brand-500 dark:text-brand-400' : 'group-hover:text-zinc-900 dark:group-hover:text-zinc-200']" />
